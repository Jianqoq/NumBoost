...
#define BroadCastLoop_Standard(type, inner_loop_size, strides_a, strides_b, shape, \
                               axis, ndim, op)                                     \
    {                                                                              \
        int max_dim = ndim - 1;                                                    \
        int outer_start = max_dim - axis;                                          \
        ...
        {                                                                          \
            ...
            {                                                                      \
                type val1 = *((type *)(b_data_ptr));                               \
                type val2 = *((type *)(a_data_ptr));                               \
                *result_data_ptr = val1 op val2;                                   \
                result_data_ptr++;                                                 \
...
#define BroadCast_Core(ndim, shape_a, shape_b, bigger, to_broadcast, result, strides_a, strides_b, shape, type, op, \
                       simd_type, simd_load, simd_op, simd_store, vec_size, simd_type_cast)                         \
    {                                                                                                               \
        type *result_data_ptr = (type *)PyArray_DATA(result);                                                       \
        ...
        {                                                                                                           \
            BroadCastLoop_Standard(type, prod, strides_a, strides_b, shape, axis, ndim, op);                        \
        }                                                                                                           \
        else                                                                                                        \
        {                                                                                                           \
...
#define Simd_float32_methods(a, b, result, op, c_type, type, simd_op)                          \
    {                                                                                          \
        ...
        {                                                                                      \
        case ADD:                                                                              \
            _BroadCast(a, b, result, op, c_type, type, __m256, _mm256_loadu_ps, _mm256_add_ps, \
                       _mm256_storeu_ps, 8, float);                                            \
            break;                                                                             \
        case SUB:                                                                              \
            _BroadCast(a, b, result, op, c_type, type, __m256, _mm256_loadu_ps, _mm256_sub_ps, \
                       _mm256_storeu_ps, 8, float);                                            \
            break;                                                                             \
        case DIV:                                                                              \
            _BroadCast(a, b, result, op, c_type, type, __m256, _mm256_loadu_ps, _mm256_div_ps, \
                       _mm256_storeu_ps, 8, float);                                            \
            break;                                                                             \
        case MUL:                                                                              \
            _BroadCast(a, b, result, op, c_type, type, __m256, _mm256_loadu_ps, _mm256_mul_ps, \
                       _mm256_storeu_ps, 8, float);                                            \
            break;                                                                             \
        case MOD:                                                                              \
            _BroadCast(a, b, result, op, c_type, type, __m256, _mm256_loadu_ps, _mm256_mul_ps, \
                       _mm256_storeu_ps, -1, float);                                           \
            break;                                                                             \
        }                                                                                      \
    }
