...
Register_Reduction_Operations_Floating_Types(sum, 0, Sum_Main);
Register_Reduction_Operations_Interger_Types(sum, 0, Sum_Main);
...
Register_Reduction_Operation(min, bool, NPY_BOOL, 1, Min_Main);
...
Register_Reduction_Operation(min, int, NPY_INT, INT_MAX, Min_Main);
Register_Reduction_Operation(min, uint, NPY_UINT, UINT_MAX, Min_Main);
Register_Reduction_Operation(min, long, NPY_LONG, LONG_MAX, Min_Main);
...
Register_Reduction_Operation(max, bool, NPY_BOOL, 0, Max_Main);
Register_Reduction_Operation(max, byte, NPY_BYTE, -SCHAR_MAX, Max_Main);
Register_Reduction_Operation(max, ubyte, NPY_UBYTE, 0, Max_Main);
Register_Reduction_Operation(max, short, NPY_SHORT, -SHRT_MAX, Max_Main);
Register_Reduction_Operation(max, ushort, NPY_USHORT, 0, Max_Main);
Register_Reduction_Operation(max, int, NPY_INT, -INT_MAX, Max_Main);
Register_Reduction_Operation(max, uint, NPY_UINT, 0, Max_Main);
Register_Reduction_Operation(max, long, NPY_LONG, -LONG_MAX, Max_Main);
Register_Reduction_Operation(max, ulong, NPY_ULONG, 0, Max_Main);
...
/*argmin def*/
Register_Arg_Reduction_Operation(argmin, float, NPY_FLOAT, NPY_INFINITYF, ArgMin_Main);
Register_Arg_Reduction_Operation(argmin, double, NPY_DOUBLE, NPY_INFINITY, ArgMin_Main);
Register_Arg_Reduction_Operation(argmin, longdouble, NPY_LONGDOUBLE, NPY_INFINITYL,
                             ArgMin_Main);
Register_Arg_Reduction_Operation(argmin, half, NPY_HALF, NPY_INFINITYF, ArgMin_Main);
Register_Arg_Reduction_Operation(argmin, bool, NPY_BOOL, 1, ArgMin_Main);
Register_Arg_Reduction_Operation(argmin, byte, NPY_BYTE, SCHAR_MAX, ArgMin_Main);
Register_Arg_Reduction_Operation(argmin, ubyte, NPY_UBYTE, USHRT_MAX, ArgMin_Main);
Register_Arg_Reduction_Operation(argmin, short, NPY_SHORT, SHRT_MAX, ArgMin_Main);
Register_Arg_Reduction_Operation(argmin, ushort, NPY_USHORT, USHRT_MAX, ArgMin_Main);
...
Register_Arg_Reduction_Operation(argmin, ulong, NPY_ULONG, ULONG_MAX, ArgMin_Main);
Register_Arg_Reduction_Operation(argmin, longlong, NPY_LONGLONG, LLONG_MAX, ArgMin_Main);
...
/*argmax def*/
Register_Arg_Reduction_Operation(argmax, float, NPY_FLOAT, -NPY_INFINITYF, ArgMax_Main);
Register_Arg_Reduction_Operation(argmax, double, NPY_DOUBLE, -NPY_INFINITY, ArgMax_Main);
Register_Arg_Reduction_Operation(argmax, longdouble, NPY_LONGDOUBLE, -NPY_INFINITYL,
                             ArgMax_Main);
Register_Arg_Reduction_Operation(argmax, half, NPY_HALF, -NPY_INFINITYF, ArgMax_Main);
Register_Arg_Reduction_Operation(argmax, bool, NPY_BOOL, 0, ArgMax_Main);
Register_Arg_Reduction_Operation(argmax, byte, NPY_BYTE, -SCHAR_MAX, ArgMax_Main);
Register_Arg_Reduction_Operation(argmax, ubyte, NPY_UBYTE, 0, ArgMax_Main);
Register_Arg_Reduction_Operation(argmax, short, NPY_SHORT, -SHRT_MAX, ArgMax_Main);
...
Register_Arg_Reduction_Operation(argmax, long, NPY_LONG, -LONG_MAX, ArgMax_Main);
Register_Arg_Reduction_Operation(argmax, ulong, NPY_ULONG, 0, ArgMax_Main);
Register_Arg_Reduction_Operation(argmax, longlong, NPY_LONGLONG, -LLONG_MAX, ArgMax_Main);
Register_Arg_Reduction_Operation(argmax, ulonglong, NPY_ULONGLONG, 0, ArgMax_Main);
