...
static PyNumberMethods tensor_operator_methods = {
    ...
    (inquiry)tensor_bool, // inquiry tensor_bool,
...
static PyMethodDef module_methods[] = {
    ...
    {"result_type", (PyCFunction)binary_result_type_, METH_FASTCALL,
     "Method docstring"},
    {"where", (PyCFunction)nb_module_where, METH_KEYWORDS | METH_VARARGS,
     "Method docstring"},
    ...
    {"max", (PyCFunction)_max, METH_KEYWORDS | METH_VARARGS,
     "Method docstring"},
    {"min", (PyCFunction)_min, METH_KEYWORDS | METH_VARARGS,
     "Method docstring"},
    ...
    {"tanh", (PyCFunction)_tanh, METH_KEYWORDS | METH_VARARGS,
     "Method docstring"},
    {"log10", (PyCFunction)_log10, METH_KEYWORDS | METH_VARARGS,
     "Method docstring"},
    {"log", (PyCFunction)_log, METH_KEYWORDS | METH_VARARGS,
     "Method docstring"},
    {"exp", (PyCFunction)_exp, METH_KEYWORDS | METH_VARARGS,
     "Method docstring"},
    {"sqrt", (PyCFunction)_sqrt, METH_KEYWORDS | METH_VARARGS,
     "Method docstring"},
