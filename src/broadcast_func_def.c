...
Register_Broadcast_Operation_Err(bool, pow_);
...
Register_Broadcast_Operation_Err(byte, pow_);
...
Register_Broadcast_Operation_Err(ubyte, pow_);
...
Register_Broadcast_Operation_Err(short, pow_);
...
Register_Broadcast_Operation_Err(ushort, pow_);
...
Register_Broadcast_Operation_Err(int, pow_);
...
Register_Broadcast_Operation_Err(uint, pow_);
...
Register_Broadcast_Operation_Err(long, pow_);
...
Register_Broadcast_Operation_Err(ulong, pow_);
...
Register_Broadcast_Operation_Err(longlong, pow_);
...
Register_Broadcast_Operation_Err(ulonglong, pow_);
...
Register_Broadcast_Operation_Err(float, mod_);
Register_Broadcast_Operation_Err(float, lshift_);
Register_Broadcast_Operation_Err(float, rshift_);
...
Register_Broadcast_Operation_Err(double, mod_);
Register_Broadcast_Operation_Err(double, lshift_);
Register_Broadcast_Operation_Err(double, rshift_);
...
Register_Broadcast_Operation_All_Err(clongdouble);
Register_Broadcast_Operation_All_Err(object);
Register_Broadcast_Operation_All_Err(string);
Register_Broadcast_Operation_All_Err(unicode);
Register_Broadcast_Operation_All_Err(void);
Register_Broadcast_Operation_All_Err(datetime);
Register_Broadcast_Operation_All_Err(timedelta);
...
Register_Broadcast_Operation_Err(half, lshift_);
Register_Broadcast_Operation_Err(half, rshift_);
