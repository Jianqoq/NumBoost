...
#define Register_FuseBackward_Operation(name, type, result_type, inner_loop_body_universal, inner_loop_body_seq, ...) \
    PyObject *name##_backward_fuse_##type(Replicate0_With_Comma(Parameter_type, __VA_ARGS__))                    \
    {                                                                                                                 \
        Perform_Universal_Operation(npy_##type, result_type, inner_loop_body_universal, inner_loop_body_seq, __VA_ARGS__);  \
    }
...
#define Register_FuseBackward_Operation_FloatingTypes(name, universal_loop_body, sequential_loop_body, ...) \
    Register_FuseBackward_Operation(name, float, NPY_FLOAT, universal_loop_body, sequential_loop_body, __VA_ARGS__);\
    Register_FuseBackward_Operation(name, double, NPY_DOUBLE, universal_loop_body, sequential_loop_body, __VA_ARGS__);\
    Register_FuseBackward_Operation(name, longdouble, NPY_LONGDOUBLE, universal_loop_body, sequential_loop_body, __VA_ARGS__);\
    Register_FuseBackward_Operation(name, half, NPY_HALF, universal_loop_body, sequential_loop_body, __VA_ARGS__);

#define Register_FuseBackward_Operation_IntergerTypes(name, universal_loop_body, sequential_loop_body, ...) \
    Register_FuseBackward_Operation(name, bool, NPY_FLOAT, universal_loop_body, sequential_loop_body, __VA_ARGS__);\
    Register_FuseBackward_Operation(name, byte, NPY_BYTE, universal_loop_body, sequential_loop_body, __VA_ARGS__);\
    Register_FuseBackward_Operation(name, ubyte, NPY_UBYTE, universal_loop_body, sequential_loop_body, __VA_ARGS__);\
    Register_FuseBackward_Operation(name, short, NPY_SHORT, universal_loop_body, sequential_loop_body, __VA_ARGS__);\
    Register_FuseBackward_Operation(name, ushort, NPY_USHORT, universal_loop_body, sequential_loop_body, __VA_ARGS__);\
    Register_FuseBackward_Operation(name, int, NPY_INT, universal_loop_body, sequential_loop_body, __VA_ARGS__);\
    Register_FuseBackward_Operation(name, uint, NPY_UINT, universal_loop_body, sequential_loop_body, __VA_ARGS__);\
    Register_FuseBackward_Operation(name, long, NPY_LONG, universal_loop_body, sequential_loop_body, __VA_ARGS__);\
    Register_FuseBackward_Operation(name, ulong, NPY_ULONG, universal_loop_body, sequential_loop_body, __VA_ARGS__);\
    Register_FuseBackward_Operation(name, longlong, NPY_LONGLONG, universal_loop_body, sequential_loop_body, __VA_ARGS__);\
    Register_FuseBackward_Operation(name, ulonglong, NPY_ULONGLONG, universal_loop_body, sequential_loop_body, __VA_ARGS__);
...
#define Register_FuseBackward_Operation_Array(name, ...)                                                                                                                                                                         \
    PyObject *(*name##_backward_fusefn[])(Replicate0_With_Comma(Parameter_type_, __VA_ARGS__)) = {name##_backward_fuse_bool, name##_backward_fuse_byte, name##_backward_fuse_ubyte, name##_backward_fuse_short,             \
...
extern PyObject *(*power_backward_fusefn[])(PyObject *a, PyObject *b, PyObject *c);
